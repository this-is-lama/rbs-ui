...
Давай теперь переделаем страницу с ресторанами

1. Рестораны должны быть как плашки на фото, где цифры это рабочее время
2. Фотографии на плашке должны скругляться и подстраиваться под ее размер   
3. Кнопка с фильтрами должна быть в виде иконки в форме квадрата со скругленными углами и располагаться на том же уровне, что и заголовок рестораны, с края справа
4. Кнопочки открыть ресторан и забронировать не должно быть, я просто должен нажимать на плашку и будет открываться страница ресторана
5. Вместо текста с текущей страницы, должны показываться кнопки с текущей страницей, дизайн этого тоже будет прикреплен
6. Текст "Выбирай ресторан по категории, названию и адресу." убрать
7. В самом низу должен быть footer
